...
function updateShare(bestScore) {
    ...
    if (bestScore > 0) {
        shareTitle = "【小游戏 - 见缝插针】我插了第" + bestScore + "关，无敌是多么寂寞！";
    } else {
        shareTitle = "【小游戏】见缝插针 - 娱乐模式";
    }
    appid = '';
    ...
    function a(a, b, l, m) {
        function n(a) {
            ...
            function(a) {
                ...
                f.check(w, a, m) ? !x.ballList.length && r() : !x.ballList.length && r()
            })
        }
        ...
        function s() {
            "fail" !== l && (a.style.backgroundColor = "#f3f47c", A = "fail", v = +new Date)
        }
