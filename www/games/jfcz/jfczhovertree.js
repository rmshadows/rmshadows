...
function play68_submitScore(score) {
    var str = score;
    try {
        parent.__4399finishgame(str);
    } catch(e) {}
}
function updateShare(bestScore) {
    var descContent = "#见缝插针# 刺激，在夹缝中生存！";
    if (bestScore > 0) {
        shareTitle = "【小游戏 - 见缝插针】我插了" + bestScore + "关，听说全世界只有4%的人玩得过第10关！";
    } else {
        shareTitle = "【小游戏】见缝插针 听说只有10%的人玩得过第10关...！";
    }
    appid = '';
...
getLevel();
if (passedNum == 60) {
    var buttonPay = document.getElementById('btnGuanzhu');
    buttonPay.style.display = 'none';
}

//$("#rehovertr" + "ee").on("ontouchstart", function () { document.getElementById('lvnew').style.display = 'block'; return false; })
...
$AJB.general.BeginStage = function() {
    ...
    function a(a) {
        function c() {
            ...
            j.innerHTML = d.isAndroid ? "START": "开始"
        }
...
$AJB.general.Levels = function() {
    ...
    function d(a) {
        var b = 1;
        return h(document.body, "mousedown",
        function() {
            b = -b
        }),
...
$AJB.general.Scene = function() {
    ...
    function a(a, b, l, m) {
        ...
        function s() {
            "fail" !== l && (a.style.backgroundColor = "#e81425", A = "fail", v = +new Date)
        }
...
$AJB.general.Game = function() {
    ...
    C = m(s);
    function gaibian_D() {
        if (passedNum) return passedNum;
        else return o.getValue(z);
    }
...
if (!IsPCHovertree()) location.href = "//hovertree.com/texiao/game/indexhvtm.htm";
*/
